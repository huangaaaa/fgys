...
var app={
    host:'http://shop.lzguoxi.com/index.php/',
    //host:'http://app.52juanmi.com/index.php/',
    img_cdn:'',
    isdebug:1,//是否开启调试功能。开启调试功能将输入所有的请求信息
    fix:'api/',
    urls:{
      mao1:'http://app.52juanmi.com/index.php/web/viewinfo/index/cid/9',//天猫1元购物
      gonggao:'http://app.52juanmi.com/index.php/web/viewinfo/index/cid/10',//天猫1元购物
      author: 'http://app.52juanmi.com/index.php/api/taobaoapi/authorcode/', //联盟授权回调页面
      sharepage: 'http://app.52juanmi.com/h5/sharegoods/index.html',    //分享的中间页面地址
      //shareapp:'http://app.52juanmi.com/h5/shareapp/index.html',    //分享APP的链接地址
      alibao:'http://app.52juanmi.com/h5/alibao.html',             //zhifub活动
      yinsi:'http://app.52juanmi.com/h5/yingsi.html',             //隐私政策
    },
